...
function createInstructions() {
	...
	text.innerHTML = '<span style="color:' + theme[0] + ';font-size:40px;">Hello!</span><br /><br /><span style="font-size:15px;"><strong>玩法如下</strong><br /><br />1.球可以拖动<br />2.点击空白处（可长按）.<br />3. 摇晃你的浏览器.<br />4.双击.<br />5. Enjoy it!</span>';
